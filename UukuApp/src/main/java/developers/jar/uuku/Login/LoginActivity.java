...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(developers.jar.uuku.R.layout.activity_login);
        txtUsername = (EditText) findViewById(developers.jar.uuku.R.id.txt_username_login);
        txtPassword = (EditText) findViewById(developers.jar.uuku.R.id.txt_pwd_login);
    ...
    public class TaskLogin extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if(Common.RESULT_SUCCESS == result) {
                if ("admin".equals(txtUsername.getText().toString())){
                    ...
                    Toast.makeText(getApplicationContext(), "Login success", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), developers.jar.uuku.MainActivity.class);
                    i.putExtra("username", txtUsername.getText().toString());
                    startActivity(i);
                }
            } else {
