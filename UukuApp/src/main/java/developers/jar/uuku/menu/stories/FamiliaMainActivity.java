...
public class FamiliaMainActivity extends AppCompatActivity implements EasyVideoCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(developers.jar.uuku.R.layout.activity_main_familia);
